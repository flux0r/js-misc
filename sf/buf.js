...
var Sf = {};
Sf.main = new Fay$$$(function(){
  return Fay$$_(Prelude.putStrLn)(Fay$$list("Hey!"));
});
Sf._Occ = function Occ(){
};
Sf._Occ.prototype.instance = "Occ";
Sf.Occ = new Fay$$$(function(){
  return new Sf._Occ();
});
Sf._OccL = function OccL(slot1){
  this.slot1 = slot1;
};
Sf._OccL.prototype.instance = "OccL";
Sf.OccL = function(slot1){
  return new Fay$$$(function(){
    return new Sf._OccL(slot1);
  });
};
Sf._OccR = function OccR(slot1){
  this.slot1 = slot1;
};
Sf._OccR.prototype.instance = "OccR";
Sf.OccR = function(slot1){
  return new Fay$$$(function(){
    return new Sf._OccR(slot1);
  });
};
Sf._Sample = function Sample(){
};
Sf._Sample.prototype.instance = "Sample";
Sf.Sample = new Fay$$$(function(){
  return new Sf._Sample();
});
Sf._SampleEvt = function SampleEvt(){
};
Sf._SampleEvt.prototype.instance = "SampleEvt";
Sf.SampleEvt = new Fay$$$(function(){
  return new Sf._SampleEvt();
});
Sf._SampleEmpty = function SampleEmpty(){
};
Sf._SampleEmpty.prototype.instance = "SampleEmpty";
Sf.SampleEmpty = new Fay$$$(function(){
  return new Sf._SampleEmpty();
});
Sf._SampleBoth = function SampleBoth(slot1,slot2){
  this.slot1 = slot1;
  this.slot2 = slot2;
};
Sf._SampleBoth.prototype.instance = "SampleBoth";
Sf.SampleBoth = function(slot1){
  return function(slot2){
    return new Fay$$$(function(){
      return new Sf._SampleBoth(slot1,slot2);
    });
  };
};
Sf._DeltaSignal = function DeltaSignal(){
};
Sf._DeltaSignal.prototype.instance = "DeltaSignal";
Sf.DeltaSignal = new Fay$$$(function(){
  return new Sf._DeltaSignal();
});
Sf._DeltaNothing = function DeltaNothing(){
};
Sf._DeltaNothing.prototype.instance = "DeltaNothing";
Sf.DeltaNothing = new Fay$$$(function(){
  return new Sf._DeltaNothing();
});
Sf._DeltaBoth = function DeltaBoth(slot1,slot2){
  this.slot1 = slot1;
  this.slot2 = slot2;
};
Sf._DeltaBoth.prototype.instance = "DeltaBoth";
Sf.DeltaBoth = function(slot1){
  return function(slot2){
    return new Fay$$$(function(){
      return new Sf._DeltaBoth(slot1,slot2);
    });
  };
};
Sf._HandlerEmpty = function HandlerEmpty(){
};
Sf._HandlerEmpty.prototype.instance = "HandlerEmpty";
Sf.HandlerEmpty = new Fay$$$(function(){
  return new Sf._HandlerEmpty();
});
Sf._HandlerSignal = function HandlerSignal(slot1){
  this.slot1 = slot1;
};
Sf._HandlerSignal.prototype.instance = "HandlerSignal";
Sf.HandlerSignal = function(slot1){
  return new Fay$$$(function(){
    return new Sf._HandlerSignal(slot1);
  });
};
Sf._HandlerEvent = function HandlerEvent(slot1){
  this.slot1 = slot1;
};
Sf._HandlerEvent.prototype.instance = "HandlerEvent";
Sf.HandlerEvent = function(slot1){
  return new Fay$$$(function(){
    return new Sf._HandlerEvent(slot1);
  });
};
Sf._HandlerBoth = function HandlerBoth(slot1,slot2){
  this.slot1 = slot1;
  this.slot2 = slot2;
};
Sf._HandlerBoth.prototype.instance = "HandlerBoth";
Sf.HandlerBoth = function(slot1){
  return function(slot2){
    return new Fay$$$(function(){
      return new Sf._HandlerBoth(slot1,slot2);
    });
  };
};
Sf._EvtIn = function EvtIn(){
};
Sf._EvtIn.prototype.instance = "EvtIn";
Sf.EvtIn = new Fay$$$(function(){
  return new Sf._EvtIn();
});
Sf._EvtInL = function EvtInL(slot1){
  this.slot1 = slot1;
};
Sf._EvtInL.prototype.instance = "EvtInL";
Sf.EvtInL = function(slot1){
  return new Fay$$$(function(){
    return new Sf._EvtInL(slot1);
  });
};
Sf._EvtInR = function EvtInR(slot1){
  this.slot1 = slot1;
};
Sf._EvtInR.prototype.instance = "EvtInR";
Sf.EvtInR = function(slot1){
  return new Fay$$$(function(){
    return new Sf._EvtInR(slot1);
  });
};
Sf._SigUpdate = function SigUpdate(){
};
Sf._SigUpdate.prototype.instance = "SigUpdate";
Sf.SigUpdate = new Fay$$$(function(){
  return new Sf._SigUpdate();
});
Sf._SigUpdateL = function SigUpdateL(slot1){
  this.slot1 = slot1;
};
Sf._SigUpdateL.prototype.instance = "SigUpdateL";
Sf.SigUpdateL = function(slot1){
  return new Fay$$$(function(){
    return new Sf._SigUpdateL(slot1);
  });
};
Sf._SigUpdateR = function SigUpdateR(slot1){
  this.slot1 = slot1;
};
Sf._SigUpdateR.prototype.instance = "SigUpdateR";
Sf.SigUpdateR = function(slot1){
  return new Fay$$$(function(){
    return new Sf._SigUpdateR(slot1);
  });
};
Sf._Sf = function Sf(slot1){
  this.slot1 = slot1;
};
Sf._Sf.prototype.instance = "Sf";
Sf.Sf = function(slot1){
  return new Fay$$$(function(){
    return new Sf._Sf(slot1);
  });
};
Sf._Init = function Init(slot1,slot2){
  this.slot1 = slot1;
  this.slot2 = slot2;
};
Sf._Init.prototype.instance = "Init";
Sf.Init = function(slot1){
  return function(slot2){
    return new Fay$$$(function(){
      return new Sf._Init(slot1,slot2);
    });
  };
};
Sf.identity = new Fay$$$(function(){
  return Fay$$_(Sf.Sf)(function($p1){
    var init = $p1;
    return Fay$$list([init,Sf.identityInit]);
  });
});
Sf.identityInit = new Fay$$$(function(){
  return Fay$$_(Fay$$_(Sf.Init)(function($p1){
    return function($p2){
      var delta = $p2;
      return Fay$$list([delta,null,Sf.identityInit]);
    };
  }))(function($p1){
    var evt = $p1;
    return Fay$$list([Fay$$list([evt]),Sf.identityInit]);
  });
});
Fay$$objConcat(Fay$$fayToJsHash,{"Occ": function(type,argTypes,_obj){
  var obj_ = {"instance": "Occ"};
  return obj_;
},"OccL": function(type,argTypes,_obj){
  var obj_ = {"instance": "OccL"};
  var obj_slot1 = Fay$$fayToJs(["user","Occ",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  return obj_;
},"OccR": function(type,argTypes,_obj){
  var obj_ = {"instance": "OccR"};
  var obj_slot1 = Fay$$fayToJs(["user","Occ",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  return obj_;
},"Sample": function(type,argTypes,_obj){
  var obj_ = {"instance": "Sample"};
  return obj_;
},"SampleEvt": function(type,argTypes,_obj){
  var obj_ = {"instance": "SampleEvt"};
  return obj_;
},"SampleEmpty": function(type,argTypes,_obj){
  var obj_ = {"instance": "SampleEmpty"};
  return obj_;
},"SampleBoth": function(type,argTypes,_obj){
  var obj_ = {"instance": "SampleBoth"};
  var obj_slot1 = Fay$$fayToJs(["user","Sample",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  var obj_slot2 = Fay$$fayToJs(["user","Sample",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot2);
  if (undefined !== obj_slot2) {
    obj_['slot2'] = obj_slot2;
  }
  return obj_;
},"DeltaSignal": function(type,argTypes,_obj){
  var obj_ = {"instance": "DeltaSignal"};
  return obj_;
},"DeltaNothing": function(type,argTypes,_obj){
  var obj_ = {"instance": "DeltaNothing"};
  return obj_;
},"DeltaBoth": function(type,argTypes,_obj){
  var obj_ = {"instance": "DeltaBoth"};
  var obj_slot1 = Fay$$fayToJs(["user","Delta",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  var obj_slot2 = Fay$$fayToJs(["user","Delta",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot2);
  if (undefined !== obj_slot2) {
    obj_['slot2'] = obj_slot2;
  }
  return obj_;
},"HandlerEmpty": function(type,argTypes,_obj){
  var obj_ = {"instance": "HandlerEmpty"};
  return obj_;
},"HandlerSignal": function(type,argTypes,_obj){
  var obj_ = {"instance": "HandlerSignal"};
  var obj_slot1 = Fay$$fayToJs(["function",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  return obj_;
},"HandlerEvent": function(type,argTypes,_obj){
  var obj_ = {"instance": "HandlerEvent"};
  var obj_slot1 = Fay$$fayToJs(["function",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  return obj_;
},"HandlerBoth": function(type,argTypes,_obj){
  var obj_ = {"instance": "HandlerBoth"};
  var obj_slot1 = Fay$$fayToJs(["user","Handler",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[1] ? (argTypes)[1] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  var obj_slot2 = Fay$$fayToJs(["user","Handler",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[1] ? (argTypes)[1] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot2);
  if (undefined !== obj_slot2) {
    obj_['slot2'] = obj_slot2;
  }
  return obj_;
},"EvtIn": function(type,argTypes,_obj){
  var obj_ = {"instance": "EvtIn"};
  return obj_;
},"EvtInL": function(type,argTypes,_obj){
  var obj_ = {"instance": "EvtInL"};
  var obj_slot1 = Fay$$fayToJs(["user","EventInput",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  return obj_;
},"EvtInR": function(type,argTypes,_obj){
  var obj_ = {"instance": "EvtInR"};
  var obj_slot1 = Fay$$fayToJs(["user","EventInput",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  return obj_;
},"SigUpdate": function(type,argTypes,_obj){
  var obj_ = {"instance": "SigUpdate"};
  return obj_;
},"SigUpdateL": function(type,argTypes,_obj){
  var obj_ = {"instance": "SigUpdateL"};
  var obj_slot1 = Fay$$fayToJs(["user","SignalUpdate",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  return obj_;
},"SigUpdateR": function(type,argTypes,_obj){
  var obj_ = {"instance": "SigUpdateR"};
  var obj_slot1 = Fay$$fayToJs(["user","SignalUpdate",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  return obj_;
},"Sf": function(type,argTypes,_obj){
  var obj_ = {"instance": "Sf"};
  var obj_slot1 = Fay$$fayToJs(["function",[["user","Sample",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],["tuple",[["user","Sample",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],["user","Sf",[["user","Initialized",[]],argTypes && (argTypes)[1] ? (argTypes)[1] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[2] ? (argTypes)[2] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]]]]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  return obj_;
},"Init": function(type,argTypes,_obj){
  var obj_ = {"instance": "Init"};
  var obj_slot1 = Fay$$fayToJs(["function",[["double"],["user","Delta",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],["tuple",[["user","Delta",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],["list",[["user","Occ",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]]]],["user","Sf",[["user","Initialized",[]],argTypes && (argTypes)[1] ? (argTypes)[1] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[2] ? (argTypes)[2] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]]]]]],_obj.slot1);
  if (undefined !== obj_slot1) {
    obj_['slot1'] = obj_slot1;
  }
  var obj_slot2 = Fay$$fayToJs(["function",[["user","Occ",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],["tuple",[["list",[["user","Occ",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]]]],["user","Sf",[["user","Initialized",[]],argTypes && (argTypes)[1] ? (argTypes)[1] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[2] ? (argTypes)[2] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]]]]]],_obj.slot2);
  if (undefined !== obj_slot2) {
    obj_['slot2'] = obj_slot2;
  }
  return obj_;
}});
Fay$$objConcat(Fay$$jsToFayHash,{"Occ": function(type,argTypes,obj){
  return new Sf._Occ();
},"OccL": function(type,argTypes,obj){
  return new Sf._OccL(Fay$$jsToFay(["user","Occ",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot1"]));
},"OccR": function(type,argTypes,obj){
  return new Sf._OccR(Fay$$jsToFay(["user","Occ",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot1"]));
},"Sample": function(type,argTypes,obj){
  return new Sf._Sample();
},"SampleEvt": function(type,argTypes,obj){
  return new Sf._SampleEvt();
},"SampleEmpty": function(type,argTypes,obj){
  return new Sf._SampleEmpty();
},"SampleBoth": function(type,argTypes,obj){
  return new Sf._SampleBoth(Fay$$jsToFay(["user","Sample",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot1"]),Fay$$jsToFay(["user","Sample",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot2"]));
},"DeltaSignal": function(type,argTypes,obj){
  return new Sf._DeltaSignal();
},"DeltaNothing": function(type,argTypes,obj){
  return new Sf._DeltaNothing();
},"DeltaBoth": function(type,argTypes,obj){
  return new Sf._DeltaBoth(Fay$$jsToFay(["user","Delta",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot1"]),Fay$$jsToFay(["user","Delta",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot2"]));
},"HandlerEmpty": function(type,argTypes,obj){
  return new Sf._HandlerEmpty();
},"HandlerSignal": function(type,argTypes,obj){
  return new Sf._HandlerSignal(Fay$$jsToFay(["function",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot1"]));
},"HandlerEvent": function(type,argTypes,obj){
  return new Sf._HandlerEvent(Fay$$jsToFay(["function",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot1"]));
},"HandlerBoth": function(type,argTypes,obj){
  return new Sf._HandlerBoth(Fay$$jsToFay(["user","Handler",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[1] ? (argTypes)[1] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot1"]),Fay$$jsToFay(["user","Handler",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[1] ? (argTypes)[1] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot2"]));
},"EvtIn": function(type,argTypes,obj){
  return new Sf._EvtIn();
},"EvtInL": function(type,argTypes,obj){
  return new Sf._EvtInL(Fay$$jsToFay(["user","EventInput",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot1"]));
},"EvtInR": function(type,argTypes,obj){
  return new Sf._EvtInR(Fay$$jsToFay(["user","EventInput",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot1"]));
},"SigUpdate": function(type,argTypes,obj){
  return new Sf._SigUpdate();
},"SigUpdateL": function(type,argTypes,obj){
  return new Sf._SigUpdateL(Fay$$jsToFay(["user","SignalUpdate",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot1"]));
},"SigUpdateR": function(type,argTypes,obj){
  return new Sf._SigUpdateR(Fay$$jsToFay(["user","SignalUpdate",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],obj["slot1"]));
},"Sf": function(type,argTypes,obj){
  return new Sf._Sf(Fay$$jsToFay(["function",[["user","Sample",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],["tuple",[["user","Sample",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],["user","Sf",[["user","Initialized",[]],argTypes && (argTypes)[1] ? (argTypes)[1] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[2] ? (argTypes)[2] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]]]]]],obj["slot1"]));
},"Init": function(type,argTypes,obj){
  return new Sf._Init(Fay$$jsToFay(["function",[["double"],["user","Delta",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],["tuple",[["user","Delta",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],["list",[["user","Occ",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]]]],["user","Sf",[["user","Initialized",[]],argTypes && (argTypes)[1] ? (argTypes)[1] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[2] ? (argTypes)[2] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]]]]]],obj["slot1"]),Fay$$jsToFay(["function",[["user","Occ",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]],["tuple",[["list",[["user","Occ",[argTypes && (argTypes)[0] ? (argTypes)[0] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]]]],["user","Sf",[["user","Initialized",[]],argTypes && (argTypes)[1] ? (argTypes)[1] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"],argTypes && (argTypes)[2] ? (argTypes)[2] : (type)[0] === "automatic" ? ["automatic"] : ["unknown"]]]]]]],obj["slot2"]));
}});
